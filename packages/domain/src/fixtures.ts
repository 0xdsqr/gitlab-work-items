  ...
  items: [
    {
      ...
      labels: [
        ...
        { name: "workflow::ready", color: "#63a6e9", textColor: "#18171d" },
      ],
    ...
    },
    {
      ...
      labels: [
        ...
        { name: "workflow::review", color: "#e9be74", textColor: "#18171d" },
      ],
    ...
    },
    {
      ...
      iid: 172,
      type: "ISSUE",
      title: "Ship the first keyboard navigation pass",
      description: "Make every board and work-item action available without a mouse.",
      state: "CLOSED",
      reference: "acme/console#172",
      namespace: "acme/console",
      author: "alex",
      assignees: ["alex"],
      labels: [{ name: "accessibility", color: "#428fdc", textColor: "#18171d" }],
      webUrl: "https://gitlab.example.com/acme/console/-/issues/172",
